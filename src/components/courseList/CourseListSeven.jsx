...
export default function CourseListSeven() {
  ...
  return (
    <div className="course-list">
      <h2 className="course-list__title">Cursos Gratuitos</h2>
      <p className="course-list__description">
        Aproveite nossos cursos gratuitos para começar sua jornada de aprendizado.
      </p>
